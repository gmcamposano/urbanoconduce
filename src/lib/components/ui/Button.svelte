<script lang="ts">
	...
	const baseStyles = 'inline-flex items-center justify-center gap-2 rounded-[6px] text-sm font-medium transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3ecf8e]/35 focus-visible:ring-offset-2 focus-visible:ring-offset-white disabled:opacity-50 disabled:pointer-events-none active:translate-y-px cursor-pointer';

	const variants = {
		default: 'bg-[#3ecf8e] text-[#171717] hover:bg-[#24b47e] shadow-sm shadow-black/5 border border-transparent',
