<script lang="ts">
	...
	import { Plus, Search, Package, Tags } from '@lucide/svelte';
...
<svelte:head>
	<title>Carga inicial - magikalInvoice</title>
</svelte:head>
...
<div class="flex flex-1 flex-col justify-start space-y-6 text-[#171717]">
	<div class="border-b border-[#ededed] pb-5">
		<h1 class="flex items-center gap-2 text-2xl font-medium tracking-tight text-[#171717]">
			<Plus class="h-6 w-6 text-[#3ecf8e]" />
			Carga inicial de mercancía
		</h1>
		<p class="mt-0.5 text-xs text-[#707070]">
			Ingresa las cantidades iniciales por variante. Se registrarán como movimientos de tipo "carga
			inicial".
		</p>
	</div>
			...
			<CardContent class="space-y-4">
				...
				<div class="flex w-full flex-col gap-1.5">
					...
					<textarea
						...
						bind:value={notes}
						rows="2"
						placeholder="Ej. Inventario inicial julio 2026"
						disabled={loading}
					...
					<table class="w-full text-left text-sm text-[#171717]">
						...
						>
							<tr>
								...
								<th class="px-6 py-4 text-right font-bold uppercase">Cantidad a ingresar</th>
							</tr>
						</thead>
